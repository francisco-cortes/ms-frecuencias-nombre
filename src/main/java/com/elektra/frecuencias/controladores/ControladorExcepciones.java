...
public class ControladorExcepciones {
  ...
  public DtoFrecuenciasResponse errorInterno(ErrorInternoException errorInterno) {
    /*
    construccion del metodo de salida
     */
    return new DtoFrecuenciasResponse(errorInterno.getFrecuenciaNombre(),errorInterno.getTotalRegistrosNombre(),
